...
import { X, Calendar, Clock, User, Mail, CheckCircle, IndianRupee } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl max-w-md w-full p-6">
          <div className="text-center">
                ...
                <div className="space-y-2 text-sm text-gray-700">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {new Date(bookedAppointment.date).toLocaleDateString('en-IN', {
                        weekday: 'long',
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{formatINR(doctor.consultationFee)}</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <p className="text-sm text-gray-600 mb-6">
              A confirmation email has been sent to {formData.patientEmail}. Please arrive 15 minutes
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="flex items-center">
                ...
                <p className="text-2xl font-bold text-blue-900">{formatINR(doctor.consultationFee)}</p>
              </div>
              <p className="text-sm text-blue-700 mt-1">
                Payment can be made at the clinic or through our secure online portal.
              </p>
            </div>
          </div>
